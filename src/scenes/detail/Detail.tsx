...
export default function Detail() {
  ...
  const { from, userData, title } = route.params as { from:string, userData:any, title:string}; // TODO - userData type
    ...
    <ScreenTemplate>
      <ScrollView style={styles.main}>
        <View style={colorScheme.content}>
          <Text style={[styles.field, {color: colorScheme.text}]}>id={userData.id}</Text>
